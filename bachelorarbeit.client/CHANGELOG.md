...
- Create Angular project with ng: `ng new bachelorarbeit.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bachelorarbeit.client.esproj`).
